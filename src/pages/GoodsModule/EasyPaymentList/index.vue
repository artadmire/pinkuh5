<template>
  <div class="pintuan">
      <h2><i onclick="window.history.go(-1)"></i>分期商品</h2>
      <div class="banner">
      ...
      <EasyPaymentUl ref='pintuanTabUl' :class='{fixedActive:isFixed}' :dataInfo='tabArr' :defaultIndex='defaultIndex' @listenFromChild='listenFromChild'></EasyPaymentUl>
...
import EasyPaymentUl from './components/EasyPaymentUL'
